...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	КонецЦикла;
	// {{ Новикова А.В. запись регистра ВКМ_ОбслуживаниеКлиентов
	...
	Движения.ВКМ_ЗадолженностьПоОбслуживанию.Записывать = Истина;
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		Движение = Движения.ВКМ_ЗадолженностьПоОбслуживанию.Добавить();
		Движение.Период = Дата;
		Движение.Контрагент = Контрагент;
		Движение.Договор = Договор;
