...
Процедура ПриСозданииНаСервере(Форма, Знач ПараметрыРазмещения = Неопределено) Экспорт
	...
	// {{ Новикова А.В. на форме документа "Реализация товаров и услуг" вывод команды "Заполнить", которая проверяет вид договора,
	//  если вид договора "абонентское обслуживание" происходит автозаполненение на основании документов "Обслуживание клиента" за месяц
